...
const OurWork = () => {
    return (
        <div className='h-80 py-8 bg-white rounded-2xl flex justify-center relative'>
            {/* Images  */}
            <div className="flex flex-col gap-20 md:gap-2 absolute right-20">
            ...
            <div className='bg-white rounded-2xl flex flex-col justify-center items-center gap-2'>
                ...
                <Title className='text-black text-3xl md:text-5xl text-center'>Some of our works</Title>
                <Text size="sm" className="text-black max-w-[350px] md:max-w-[500px] text-center text-[16px] md:text-[20px]">
